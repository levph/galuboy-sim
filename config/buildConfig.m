...
%   runtime. RX height defaults: 1.5 m infantry / 2.5 m vehicular.
    ...
    % placement_diameter_km is the DIAMETER of the RX-placement disk in km
    % (centered on each region's centroid). Default 5 km = the urban_suburban
    % footprint; report/run_for_report.m overrides to 10 km for the non-
    % suburban regions.
    config.rx.placement_diameter_km     = 5;     % km (diameter, NOT radius)
